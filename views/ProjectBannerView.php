		...
		<div class="project-banner-content">
			<ul class="project-banner-content-list">
				<?php foreach($_DATA["projects"] as $project){ ?>
					...
					<li class="project-banner-content-list-item" data-project-id="<?=$project['project_id']?>" data-fav-count="<?=$project["fav_count"]?>" data-participator-count="<?=$project["participator_count"]?>" data-editable="<?=(int)$editable?>">
